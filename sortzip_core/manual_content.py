...
<tr><td><b>文件</b></td><td>源文件夹、目标目录、<b>包含子文件夹</b>、每组文件数、排序方式（文件名/修改时间）、压缩密码、分卷设置（留空自动）</td></tr>
...
<tr><td><b>开始</b></td><td>选择压缩格式、<b>输出目录（生成 List.txt 命名对照表）</b>、执行/取消、实时进度条与日志、完成后统计报告（含打开目标文件夹）</td></tr>
</table>
